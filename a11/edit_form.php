...
$results_movie = $mysqli->query($sql_movie);
if ( $results_movie == false ) {
    echo $mysqli->error;
    exit();
}

$row_movie = $results_movie->fetch_assoc();
    ...
    <div class="container">
        ...
        <form action="edit_confirmation.php" method="POST">
            ...
            <div class="form-group row">
                <label for="dvd-title-id" class="col-sm-3 col-form-label text-sm-right">
                    Title: <span class="text-danger">*</span>
                </label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="dvd-title-id" name="title" value="<?php echo $row_movie['title']; ?>">
                </div>
            </div> <!-- .form-group -->
                ...
                <div class="col-sm-9">
                    <select name="genre" id="genre-id" class="form-control">
                        ...
                        <?php while( $row = $results_genres->fetch_assoc() ): ?>
                            ...
                            <?php if ( $row['genre_id'] == $row_movie['genre_id'] ) : ?>
                ...
                <div class="col-sm-9">
                    <select name="rating" id="rating-id" class="form-control">
                        ...
                        <?php while( $row = $results_ratings->fetch_assoc() ): ?>
                            ...
                            <?php if ( $row['rating_id'] == $row_movie['rating_id'] ) : ?>
                ...
                <div class="col-sm-9">
                    <select name="label" id="label-id" class="form-control">
                        ...
                        <?php while( $row = $results_labels->fetch_assoc() ): ?>
                            ...
                            <?php if ( $row['label_id'] == $row_movie['label_id'] ) : ?>
                ...
                <div class="col-sm-9">
                    <select name="format" id="format-id" class="form-control">
                        ...
                        <?php while( $row = $results_formats->fetch_assoc() ): ?>
                            ...
                            <?php if ( $row['format_id'] == $row_movie['format_id'] ) : ?>
                ...
                <div class="col-sm-9">
                    <select name="sound" id="sound-id" class="form-control">
                        ...
                        <?php while( $row = $results_sounds->fetch_assoc() ): ?>
                            ...
                            <?php if ( $row['sound_id'] == $row_movie['sound_id'] ) : ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="award" min="0" id="award-id" class="form-control" value="<?php echo $row_movie['award']; ?>">
                </div>
            </div> <!-- .form-group -->
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="date" name="date" id="date-id" class="form-control" value="<?php echo $row_movie['release_date']; ?>">
                </div>
            </div> <!-- .form-group -->
